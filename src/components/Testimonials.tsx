...
export default function Testimonials() {
  ...
  return (
    <section className="relative overflow-hidden bg-[color:var(--ap-navy)] py-20 md:py-24">
      <div 
        className="wave-pattern absolute inset-0 opacity-10"
        style={{
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="mx-auto max-w-3xl">
          <div className="relative rounded-lg bg-white px-8 py-10 md:px-12 md:py-12">
            <svg 
