        ...
        <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-2xl border border-black/10 bg-white/60 p-6">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[color:var(--ap-navy)]/10">
                <svg className="h-6 w-6 text-[color:var(--ap-navy)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="mt-2 text-sm leading-7 text-[color:var(--ap-navy)]/70">
              ...
              <ul className="mt-4 space-y-2 text-sm text-[color:var(--ap-navy)]/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[color:var(--ap-burnt-orange)]" />
