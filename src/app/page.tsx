        ...
        <section className="py-14 md:py-18">
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
              ...
              >
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[color:var(--ap-navy)]/10">
                  <svg className="h-5 w-5 text-[color:var(--ap-navy)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
