        ...
        <section className="mx-auto max-w-6xl px-6 py-20 md:py-24">
          <div className="flex flex-col gap-2 md:flex-row md:items-baseline md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm leading-relaxed text-[color:var(--ap-navy)]/70">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-md bg-[color:var(--ap-navy)]/5">
                <svg className="h-4 w-4 text-[color:var(--ap-navy)]/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h3 className="text-sm font-semibold text-[color:var(--ap-navy)]">
                Individual Tax Prep
              </h3>
              ...
              <p className="mt-4 inline-flex items-center gap-1 text-xs font-medium text-[color:var(--ap-burgundy)] group-hover:underline">
            ...
            >
              ...
              <h3 className="text-sm font-semibold text-[color:var(--ap-navy)]">Bookkeeping</h3>
              <p className="mt-2 flex-1 text-sm leading-relaxed text-[color:var(--ap-navy)]/60">
            ...
            >
              ...
              <h3 className="text-sm font-semibold text-[color:var(--ap-navy)]">Non-Profit Tax Prep</h3>
              <p className="mt-2 flex-1 text-sm leading-relaxed text-[color:var(--ap-navy)]/60">
