              ...
              {quickLinksOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 rounded-lg border border-white/10 bg-[color:var(--ap-navy)] p-2 shadow-xl">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 rounded-md px-3 py-2 text-sm normal-case tracking-normal text-[color:var(--ap-burnt-orange)] transition-colors hover:bg-white/10"
                  >
          ...
          <div className="relative mx-auto max-w-6xl px-6 pb-10 pt-8 md:pb-16 md:pt-12">
            <div className="grid items-center gap-12 md:grid-cols-2 lg:gap-16">
              <div className="text-center md:text-left">
                ...
                <p className="mx-auto mt-6 max-w-md text-lg leading-7 text-[color:var(--ap-cream)]/75 md:mx-0">
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 md:mt-10 md:justify-start md:gap-x-6">
                  <p className="text-base font-medium text-white">Issues caught early</p>
                  <span className="hidden text-white/30 md:inline">•</span>
                  <p className="text-base font-medium text-white">Real support</p>
                  <span className="hidden text-white/30 md:inline">•</span>
                  <p className="text-base font-medium text-white">Two decades experience</p>
                </div>
              </div>
              ...
              <div className="relative hidden md:block md:justify-self-end">
                <div className="relative rounded-xl border border-white/10 bg-white/[0.02] p-6">
                  ...
                  <div className="mt-4 text-center">
                    <p className="text-sm font-medium uppercase tracking-wide text-[color:var(--ap-cream)]/70">
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-xl text-base leading-relaxed text-[color:var(--ap-navy)]/70">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              >
                ...
                <p className="mt-3 flex-1 text-lg leading-relaxed text-[color:var(--ap-navy)]/70">
              ...
              <div className="rounded-xl border border-[color:var(--ap-navy)]/8 bg-white p-6 shadow-sm md:p-8">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group flex items-center gap-3 rounded-lg border border-[color:var(--ap-burgundy)]/30 bg-[color:var(--ap-burgundy)]/10 px-4 py-3 transition-all hover:bg-[color:var(--ap-burgundy)]/20"
                  >
                    <div className="flex h-9 w-9 items-center justify-center rounded-md bg-[color:var(--ap-burgundy)]/20">
                      <svg className="h-4 w-4 text-[color:var(--ap-burgundy)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                      </svg>
                    </div>
                    <span className="flex-1 text-sm font-medium text-[color:var(--ap-burgundy)]">Client Portal</span>
                    <svg className="h-4 w-4 text-[color:var(--ap-burgundy)]/50 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                  </a>
                </div>
              ...
              <div className="rounded-xl border border-[color:var(--ap-navy)]/8 bg-white p-6 shadow-sm md:p-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[color:var(--ap-navy)]/50">Eastern Time (ET)</p>
                  </div>
                </div>
                <div className="mt-6 space-y-3">
                  {officeStatus.isOpen && (
